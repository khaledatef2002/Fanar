...
<div class="navbar-custom topnav-navbar topnav-navbar-dark">
    <div class="px-0 mx-0 d-flex justify-content-between">
        <div class="visit_website d-flex align-items-center">
            <h4><?php echo $this->db->get_where('settings', array('key' => 'system_name'))->row()->value; ?></h4>
            <a href="<?php echo site_url('home'); ?>" target="" class="btn btn-primary ml-3 d-none d-md-inline-block"><?php echo get_phrase('visit_website'); ?></a>
        </div>
        ...
        <ul class="list-unstyled topbar-right-menu mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle arrow-none btn" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
