...
<head>
    <title><?php echo get_phrase('live_class'); ?> : <?php echo $booking_details['title']; ?></title>
    <meta charset="utf-8" />
...
<body>
    ...
    function start_zoom() {
        ...
        var USER_NAME = "<?php echo $logged_user_details['first_name']; ?>";
        ...
        var meetConfig = {
            ...
            userName: USER_NAME,
            passWord: PASSWORD,
            leaveUrl: "<?php echo site_url('my_bookings') ?>",
            role: 0
        };
