<div class="instructor px-3 rounded-4 mx-0 py-3">
            ...
            <div class="row g-3">
                <div class="col-lg-3 col-md-4 col-sm-4 col-4">
                    <div class="instructor-img">
                        <img loading="lazy" class="mb-0" src="<?php echo $this->user_model->get_user_image_url($instructor['id']); ?>">
                    </div>
                </div>
                <div class="col-lg-9 col-md-8 col-sm-8 col-8 d-flex flex-column justify-content-center">
                    ...
                    <div class="instructor-icon mt-3 my-0">
                        ...
                        <?php endforeach; ?>
                        <a class="py-2" style="color: #fe7569;" href="<?php echo site_url('home/instructor_page/'.$instructor_id) ?>" target="_blank"><?php echo get_phrase('View Profile'); ?></a>
                    </div>
                </div>
            </div>
        <?php endif; ?>
