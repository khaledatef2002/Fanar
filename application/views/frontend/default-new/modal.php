    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header p-3">
                <h5 class="title"></h5>
                <button type="button" class="btn ms-auto py-0 px-2" style="background-color: #ff7468;color: white;" data-bs-dismiss="modal" aria-hidden="true" onclick="player.pause();">&times;</button>
            </div>
            <div class="modal-body" style="overflow:auto;">
            </div>
        </div>
