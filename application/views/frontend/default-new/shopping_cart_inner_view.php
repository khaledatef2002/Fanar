...
<div class="row">
    ...
    <div class="col-lg-3 col-md-4">
        <div class="cart-total">
            ...
            <!-- Chicking if user entered a non empty coupon code -->
            <?php if (isset($coupon_code) && !empty($coupon_code)) : ?>
                ...
                <?php $appliable = $this->coupon_model->is_coupon_conditions_appliable_cart($coupon_code, $this->session->userdata('cart_items')); ?>
                <!-- Checking if coditions are valid -->
                <?php if($appliable): ?>
                    <!-- Check Discount Type -->
                    <?php $coupon_discounted_price = $this->coupon_model->calc_cart_discount($coupon_details, $this->session->userdata('cart_items')); ?>
            ...
            <!-- Checking if user entered empty coupon code -->
            ...
            <?php if (isset($coupon_code) && !empty($coupon_code) && isset($coupon_details) && $coupon_details['discount'] == 100 && $total == 0 && $coupon_details['expiry_date'] >= time()): ?>
