...
<head>
	...
	if (in_array($page_name, $seo_pages)):
		...
		<meta property="twitter:description" content="<?php echo $course_details['meta_description']; ?>" />
	<?php elseif($page_name == 'blog_details'): ?>
		...
		<meta property="og:description" content="<?php echo ellipsis(strip_tags(htmlspecialchars_decode_($blog_details['description'])), 140); ?>" />
		<meta property="twitter:description" content="<?php echo ellipsis(strip_tags(htmlspecialchars_decode_($blog_details['description'])), 140); ?>" />
	<?php elseif($page_name == 'blogs'): ?>
		...
		<meta property="twitter:description" content="<?php echo get_frontend_settings('blog_page_subtitle'); ?>" />
	<?php else: ?>
		<meta name="keywords" content="<?php echo get_settings('website_keywords'); ?>"/>
		...
		<meta property="twitter:description" content="<?php echo get_settings('website_description'); ?>" />
	<?php endif; ?>
	...
	<?php if($page_name == "course_page"): ?>
		...
		<meta property="twitter:title" content="<?php echo $title['title']; ?>" />
		<meta name="title" content="<?php echo $title['title']; ?>" />
		<meta property="og:image" content="<?php echo $this->crud_model->get_course_thumbnail_url($course_id); ?>">
		<meta property="twitter:image" content="<?php echo $this->crud_model->get_course_thumbnail_url($course_id); ?>" />
	<?php elseif($page_name == 'blog_details'): ?>
		<meta property="og:title" content="<?php echo $blog_details['title']; ?>" />
		<meta property="twitter:title" content="<?php echo $blog_details['title']; ?>" />
		<meta name="title" content="<?php echo $blog_details['title']; ?>" />
		...
		<meta property="twitter:image" content="<?php echo base_url($blog_banner); ?>" />
	<?php elseif($page_name == 'blogs'): ?>
		<meta property="og:title" content="<?php echo get_frontend_settings('blog_page_title'); ?>" />
		<meta property="twitter:title" content="<?php echo get_frontend_settings('blog_page_title'); ?>" />
		<meta name="title" content="<?php echo get_frontend_settings('blog_page_title'); ?>" />
		<meta property="og:image" content="<?php echo site_url('uploads/blog/page-banner/'.get_frontend_settings('blog_page_banner')); ?>">
		<meta property="twitter:image" content="<?php echo site_url('uploads/blog/page-banner/'.get_frontend_settings('blog_page_banner')); ?>" />
	<?php else: ?>
		<meta property="og:title" content="<?php echo $page_title; ?>" />
		<meta property="twitter:title" content="<?php echo $page_title; ?>" />
		<meta name="title" content="<?php echo $page_title; ?>" />
		<meta property="og:image" content="<?= base_url("uploads/system/".get_current_banner('banner_image')); ?>">
		<meta property="twitter:image" content="<?= base_url("uploads/system/".get_current_banner('banner_image')); ?>" />
	<?php endif; ?>
