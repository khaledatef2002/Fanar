...
class Home extends CI_Controller
{
    ...
    public function set_mode() {
        $dark_mode = $this->input->post('theme_mode');
        $this->session->set_userdata('theme_mode', $dark_mode);
    }

    public function instructor()
    {
        $page_data['page_name'] = "become_instructor_details";
        $page_data['page_title'] = site_phrase('Instructor');
    ...
    public function sign_up_teacher()
    {
        ...
        $page_data['page_name'] = 'sign_up_teacher';
        $page_data['page_title'] = site_phrase('sign_up_teacher');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
    ...
    function coupon_offer_100_percent()
    {
        ...
        if (count($cart_items) > 0 && $coupon_code && $coupon_details['discount'] == 100 && $coupon_details['expiry_date'] >= time() && $enrol_user_id > 0 && $this->session->userdata('user_login')) {
