...
class Admin extends CI_Controller
{
    ...
    function server_side_users_data()
    {
        ...
        $columns = array('id', 'id', 'first_name', 'email', 'phone', 'id', 'date_added', 'id');
        ...
        $total_number_of_row = $this->db->where('role_id !=', 1)->where('is_instructor !=', 1)->get('users')->num_rows();
        ...
        foreach ($students as $key => $student) :
            ...
            $nestedData['date_added'] = date("Y-m-d h:i:sa", $student['date_added']);
    ...
    public function coupon_form($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == 'add_coupon_form') {
            $page_data['categories'] = $this->crud_model->get_categories();
            $page_data['bundles'] = $this->crud_model->get_bundles();
            ...
            $page_data['coupon_categories'] = $this->crud_model->get_coupon_category($page_data['coupon']['id'])->result_array();
            $page_data['coupon_sub_categories'] = $this->crud_model->get_coupon_sub_category($page_data['coupon']['id'])->result_array();
            $page_data['coupon_bundles'] = $this->crud_model->get_coupon_bundle($page_data['coupon']['id'])->result_array();
            $page_data['coupon_students'] = $this->crud_model->get_coupon_student($page_data['coupon']['id'])->result_array();
